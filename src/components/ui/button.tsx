    ...
    variants: {
      variant: {
        ...
        link: "text-primary underline-offset-4 hover:underline",
          outlineDark: "border border-[#F1F5F9] border-[3px] text-black hover:bg-grey/10 font-arial font-normal text-sm",
          dark: "bg-black text-white hover:bg-black/80  hover:border font-arial font-normal text-sm ",
